    ...
    model(0)
{
	...
	ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a NOBL address (e.g. NoBlVxeBAu1romfLQGxC3JvZ6SCsuoE1mU)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid NOBL address"));
        }
        else
        {
